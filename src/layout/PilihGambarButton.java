...
public class PilihGambarButton extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        buttonPanel.setBackground(new java.awt.Color(153, 255, 153));

        btnGlassFish.setBackground(new java.awt.Color(255, 51, 51));
        btnGlassFish.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        ...
        btnJavaEE.setBackground(new java.awt.Color(255, 51, 51));
        btnJavaEE.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        ...
        btnPostgreSQL.setBackground(new java.awt.Color(255, 51, 51));
        btnPostgreSQL.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
